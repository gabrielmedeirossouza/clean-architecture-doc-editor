...
import { ISmartChipViewModel } from "@/interface-adapters/protocols/presenters/smart-chip-presenter/view-model";
...
export class ListSmartChipPresenter implements IListSmartChipUseCaseOutputPort {
	...
	public ListResponse(result: IPersistedEntity<ISmartChip>[]): void {
		return this._outputPort.listOutput?.Notify(this._MapSmartChipListToViewModelList(result));
	}
